...
Answer:
It is not possible to complete this task because it is required to install an additional dependency (ag-grid-enterprise) and follow the steps in the documentation at the following link (https://www.ag-grid.com/react-data-grid/cell-selection/) to complete it. But according to the instructions it is not allowed.
